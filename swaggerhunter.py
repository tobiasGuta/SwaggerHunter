...
def interactive_tui():
    ...
    # keep the interactive menu looping until the user chooses Exit (6)
    while True:
        ...
        # ---------- Option 5: Verbose output ----------
            ...
            for i, e in enumerate(report['endpoints'][:50], 1):
                ...
                console.print()
            # after showing verbose output, loop back to menu
            continue
